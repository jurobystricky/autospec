...
class Specfile(object):
    ...
    def write_prep(self, ruby_pattern=False):
        ...
        if ruby_pattern:
            ...
            if self.default_pattern == 'R':
                ...
                # The toplevel source file is a text file, no %setup needed
                pass
            else:
    ...
    def write_godep_pattern(self):
        ...
        self._write_strip(f"install -m 0644 %{{SOURCE0}} {list_file}")
        for idx, source in enumerate(self.sources["godep"]):
